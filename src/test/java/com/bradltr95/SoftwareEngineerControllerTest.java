...
class SoftwareEngineerControllerTest {
    ...
    void testCreateAndGetSoftwareEngineer() {
        ...
        ResponseEntity<SoftwareEngineer> postResponse = restTemplate.postForEntity("/engineers", engineer, SoftwareEngineer.class);
        ...
        ResponseEntity<SoftwareEngineer> getResponse = restTemplate.getForEntity("/engineers/" + createdEngineer.getId(), SoftwareEngineer.class);
